...
(function (root, factory) {
     ...
     *
     * Use this to retrieve temporary objects you have registered with [[Scratchpad.register]].
     *
     * See [[Scratchpad]] for more info.
     **/
    ...
    /**
     * Scratchpad( [fn] ) -> Scratch|Function
    ...
    /**
     * Scratchpad.fn( fn ) -> Function
     * - fn (Function): Some function you'd like to wrap in a scratch session. First argument is the scratch instance. See [[Scratchpad]].
     * + (Function): The wrapped function that can be reused like the original minus the first (scratch) parameter.
     *
     * Wrap a function in a scratch session.
     *
     * Same as calling `Scratchpad( fn )` with a function specified.
     **/
    ...
    /**
     * Scratchpad.register( name, constructor )
